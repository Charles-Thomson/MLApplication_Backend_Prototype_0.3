...
from src.application.lib.environment.environment_protocol import EnvironemntProtocol

from src.application.lib.environment.environment_observation.static_state_observation import (
